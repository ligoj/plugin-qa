...
public class SonarPluginResourceTest extends AbstractServerTest {
	...
	public void validateProjectNotFound() throws IOException {
		...
		final Map<String, String> parameters = nodeResource.getParametersAsMap("service:kpi:sonar:bpr");
	...
	public void validateAdminAccess() throws Exception {
		...
		final String version = resource.validateAdminAccess(nodeResource.getParametersAsMap("service:kpi:sonar:bpr"));
		Assert.assertEquals("4.3.2", version);
	}
	...
	public void validateAdminAccessConnectivityFail() throws Exception {
		...
		resource.validateAdminAccess(nodeResource.getParametersAsMap("service:kpi:sonar:bpr"));
	}
	...
	public void findProjectByName() throws Exception {
		...
		final List<SonarProject> projects = resource.findAllByName("service:kpi:sonar:bpr", "Com");
